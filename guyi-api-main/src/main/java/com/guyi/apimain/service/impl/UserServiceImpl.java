...
import static com.guyi.apimain.constant.UserConstant.ADMIN_ROLE;
import static com.guyi.apimain.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = DigestUtils.md5DigestAsHex((SALT
                    + userAccount
                    + RandomUtil.randomNumbers(5))
                    .getBytes(StandardCharsets.UTF_8));
            String secretKey = DigestUtils.md5DigestAsHex((SALT
                    + userAccount
